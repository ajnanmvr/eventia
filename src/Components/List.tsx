...
import CardSkeleton from "./Skeleton/CardLoading";
...
function List({ fullData, category }: ListProps) {
  ...
  const sortCards = () => {
    ...
    if (sortOption === "a-z") {
      ...
      sortedCardsCopy.sort(
        (a, b) => ((a.discountPrice || 0) as number) - ((b.discountPrice || 0) as number)
      );
    } else if (sortOption === "price-desc") {
      sortedCardsCopy.sort(
        (a, b) => ((b.discountPrice || 0) as number) - ((a.discountPrice || 0) as number)
      );
    }
